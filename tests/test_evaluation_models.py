...
def test_evaluation_models_import_and_funcs(tmp_path, monkeypatch):
    ...
    try:
        ...
        spec = importlib.util.spec_from_file_location('evaluation_models', str(src_path))
    ...
    # janelaDeslizanteNDias
    X2, y2 = mod.janelaDeslizanteNDias(arr, seq_length=1, dias_futuros=1)
